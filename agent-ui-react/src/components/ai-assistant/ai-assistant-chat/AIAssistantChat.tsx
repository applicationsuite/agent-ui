...
export const AIAssistantChat = (props: IAssistantChatProps) => {
  ...
  const renderContent = (isSidebar: boolean) => {
    ...
    if (
      state.activeNavItem === AssistantChatNavItem.StarterPrompts
    ) {
      return (
        <StarterPromptPage
          agents={agents}
    ...
    if (
      state.activeNavItem === AssistantChatNavItem.Templates
    ) {
      return (
        <TemplatePage
          agents={agents}
            ...
            <div className={agentClasses.headerActions}>
              ...
              {!isFullScreen && (
                <>
                  ...
                  {hasFeature(features, AIAssistantFeature.ConversationHistory) && (
                    <button
                      className={mergeClasses(
                        agentClasses.sidePanelHeaderButton,
                  ...
                  {hasFeature(features, AIAssistantFeature.Settings) && (
                    <Tooltip content="Settings" relationship="label">
                      <button
                        ...
                        aria-label="Settings"
                        onClick={() =>
                          handleSidePanelNavSelect(AssistantChatNavItem.Settings)
                        }
                      >
