...
export const ChatArea = (props: IChatAreaProps) => {
      ...
      <div className={classes.thread}>
        <Skeleton animation="pulse">
          <div className={classes.userBlock}>
            ...
            <SkeletonItem size={36} style={{ width: '45%', alignSelf: 'flex-end' }} />
          </div>
          ...
          <div className={classes.userBlock}>
            <SkeletonItem size={12} style={{ width: '60px' }} />
            <SkeletonItem size={28} style={{ width: '35%', alignSelf: 'flex-end' }} />
          </div>
          <div className={classes.assistantBlock}>
            <SkeletonItem shape="circle" size={28} />
  ...
  if (messages?.error && (messages.data?.length ?? 0) === 0) {
    return <div className={classes.thread}>{messages.error}</div>;
  }
        ...
        return (
          ...
          >
            <MessageRenderer
              ...
              cachedResolved={message.id ? templateCache.get(message.id) : undefined}
