...
export class AppConfig {
  ...
  private static getConfigFromEnv(env: any, configData: IConfig): IConfig {
    return {
      ...
      msal: {
        clientId: env.MSAL_CLIENT_ID || configData.msal.clientId,
        tenantId: env.MSAL_TENANT_ID || configData.msal.tenantId,
        authority: env.MSAL_AUTHORITY || configData.msal.authority,
        scopes: configData.msal.scopes,
      },
    };
  }
