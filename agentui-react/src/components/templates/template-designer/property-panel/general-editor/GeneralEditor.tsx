...
import type { ITemplateControl, IButtonControl, ButtonAppearance, ButtonPlacement } from '../../../templates.models';
        ...
        <>
          ...
          <FieldGroup label="Tooltip" className={classes.field}>
            <Input
              ...
              value={btn.tooltip ?? ''}
              onChange={(_, d) =>
                onUpdate(control.id, { tooltip: d.value } as Partial<IButtonControl>)
              }
            />
          </FieldGroup>
