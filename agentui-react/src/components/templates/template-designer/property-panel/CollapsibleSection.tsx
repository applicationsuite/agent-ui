    ...
    <div className={classes.sectionGroup}>
      ...
      >
        ...
        <ChevronDown20Regular
          className={mergeClasses(classes.sectionChevron, !expanded && classes.sectionChevronCollapsed)}
        />
      </div>
      <div
        className={mergeClasses(classes.sectionBody, !expanded && classes.sectionBodyHidden)}
      >
        {children}
      </div>
    </div>
