...
export const ControlRenderer: React.FC<IControlRendererProps> = ({
  ...
  switch (control.type) {
    ...
    case ControlType.Button:
      return <Button {...resolveButton(control, data)} onAction={onAction} serverData={data} />;
    case ControlType.Table:
      return <Table {...resolveTable(control, data)} onAction={onAction} serverData={data} />;
...
const InputFieldRenderer: React.FC<{ control: IInputFieldControl }> = ({ control }) => {
