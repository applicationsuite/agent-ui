            ...
            <>
              <div className={mergedStyles.settingRow}>
                <div className={classes.settingCopy}>
                  <span className={mergedStyles.settingLabel}>Agent activity</span>
                  <span className={mergedStyles.settingDescription}>
                    Show agent background activities while responding to user prompts
                  </span>
                </div>
                <Switch
              ...
              <div className={mergedStyles.settingRow}>
                <div className={classes.settingCopy}>
                  <span className={mergedStyles.settingLabel}>Raw response</span>
                  <span className={mergedStyles.settingDescription}>
