...
export type AIAssistantTheme = 'light' | 'dark' | 'webLight' | 'webDark' | string;
export declare enum AIAssistantDisplayMode {
    SidePanel = "SidePanel",
...
export declare enum AIAssistantFeature {
...
export declare const hasFeature: (features: AIAssistantFeature[] | undefined, feature: AIAssistantFeature) => boolean;
export declare enum AIAssistantActionType {
    SetModel = "SetModel",
...
export type IAIAssistantProps = IAssistantBasicProps & IAIAssistantBaseProps & ({
...
export declare const CANCELLED_MESSAGE = "The request has been cancelled.";
export declare const DEFAULT_DEPLOYMENT = "gpt-5.2";
export declare const DEFAULT_API_VERSION = "2024-05-01-preview";
export declare const AI_ASSISTANT_HEADER_TEXT = "AI Assistant";
 ...
 */
export declare enum AIAssistantPermission {
    View = "view",
