...
import { TemplatePageActions, } from './TemplatePage.actions';
const initialState = {
...
export const useTemplatePage = (props, service) => {
    ...
    if (!actionsRef.current) {
        actionsRef.current = new TemplatePageActions(dispatch, () => stateRef.current, service);
    }
