import { IAIAssistantMessage, IResolvedTemplate, ITemplateInfo } from '../../../../AIAssistant.models';
export type ResolveTemplateFn = (templateInfo: ITemplateInfo | undefined, userMessageText: string | undefined, payload: unknown, customPrompt: string | undefined, signal: AbortSignal) => Promise<IResolvedTemplate | undefined>;
