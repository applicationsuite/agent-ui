import { AIAssistantActionType, AIAssistantFeature, IEntity, IAIAssistantConversation, IAIAssistantMessage, IAIAssistantModel, IAIAssistantStarterPrompt, IAIAssistantTemplate, IAssistantBasicProps, IResolvedTemplate, ITemplateInfo } from '../AIAssistant.models';
export declare enum AssistantChatNavItem {
    NewChat = "NewChat",
    Chats = "Chats",
...
export interface IAssistantChatProps extends IAssistantBasicProps {
    ...
    onAction?: (action: AIAssistantActionType, payload?: unknown) => Promise<unknown> | void;
