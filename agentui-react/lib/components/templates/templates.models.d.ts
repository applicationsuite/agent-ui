...
export type FormInputType = 'text' | 'textarea' | 'number' | 'date' | 'dropdown' | 'checkbox' | 'toggle' | 'radio';
...
export type ITemplateControl = IFieldControl | IButtonControl | ITableControl | IBadgeControl | IImageControl | IProgressBarControl | IInputFieldControl | ISeparatorControl;
...
export declare const TEMPLATE_CONSTANTS: {
    HELLO_WORLD_TEMPLATE_ID: string;
};
/**
...
export type OrderedItem = {
    type: 'control';
    item: ITemplateControl;
} | {
    type: 'section';
    item: ISectionControl;
};
export declare const getOrderedItems: (children: ITemplateControl[] | undefined, sections: ISectionControl[] | undefined, ordering: string[] | undefined) => OrderedItem[];
