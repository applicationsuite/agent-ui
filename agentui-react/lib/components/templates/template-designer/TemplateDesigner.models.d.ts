...
export declare enum TemplateDesignerMode {
    Design = "design",
    Preview = "preview",
    JSON = "json"
}
...
export interface ITemplateDesignerProps {
    ...
    isReadOnly?: boolean;
    onSave?: (template: ITemplate, templateDataSource?: Record<string, unknown> | string) => void;
    onClose?: () => void;
}
export declare enum TemplateDesignerActionType {
    Save = "Save",
    Cancel = "Cancel",
